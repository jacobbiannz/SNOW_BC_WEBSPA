...
//----------------------------------------------------------------------------------------------------------
    ...
    updateCountry(country: ICountry): Observable<ICountry> {
        ...
        return this.dataService.putWithId(this.countryUrl, country).pipe(map((response: Response) => { 
            return response.json();
        }));
    ...
    createCountry(country: ICountry): Observable<ICountry> {
        ...
        return this.dataService.post(this.countryUrl, country).pipe(map((response: Response) => {
            return response.json();
        }));
    }
...
//----------------------------------------------------------------------------------------------------------
    ...
    updateProvience(countryId : string, provience: IProvience): Observable<IProvience> {
        ...
        return this.dataService.putWithId(this.provienceUrl, provience).pipe(map((response: Response) => { 
            return response.json();
        }));
    ...
    createProvience(countryId : string, provience: IProvience): Observable<IProvience> {
        ...
        return this.dataService.post(this.provienceUrl, provience).pipe(map((response: Response) => {
            return response.json();
        }));
    }
...
//----------------------------------------------------------------------------------------------------------
    ...
    updateCity(countryId : string, provienceId: string, city: ICity): Observable<ICity> {
        ...
        return this.dataService.putWithId(this.cityUrl, city).pipe(map((response: Response) => { 
            return response.json();
        }));
    }
    ...
    createCity(countryId : string, provienceId: string, city: ICity): Observable<ICity> {
        ...
        return this.dataService.post(this.cityUrl, city).pipe(map((response: Response) => {
            return response.json();
        }));
    }
//----------------------------------------------------------------------------------------------------------
