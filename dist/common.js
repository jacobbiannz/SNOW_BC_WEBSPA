...
/* harmony import */ var _shared_service_configuration_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/service/configuration.service */ "./src/app/shared/service/configuration.service.ts");
...
var Admin_DestinationService = /** @class */ (function () {
    ...
    Admin_DestinationService.prototype.getCountries = function () {
        ...
        return this.dataService.get(this.countryUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
    ...
    Admin_DestinationService.prototype.updateCountry = function (country) {
        ...
        return this.dataService.putWithId(this.countryUrl, country).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
            return response.json();
        }));
    };
    Admin_DestinationService.prototype.createCountry = function (country) {
        ...
        return this.dataService.post(this.countryUrl, country).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
            return response.json();
        }));
    };
    //----------------------------------------------------------------------------------------------------------
    Admin_DestinationService.prototype.getProviences = function (countryId) {
        ...
        return this.dataService.get(this.provienceUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
    ...
    Admin_DestinationService.prototype.updateProvience = function (countryId, provience) {
        ...
        return this.dataService.putWithId(this.provienceUrl, provience).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
            return response.json();
        }));
    };
    Admin_DestinationService.prototype.createProvience = function (countryId, provience) {
        ...
        return this.dataService.post(this.provienceUrl, provience).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
            return response.json();
        }));
    };
    //----------------------------------------------------------------------------------------------------------
    Admin_DestinationService.prototype.getCities = function (countryId, provienceId) {
        ...
        return this.dataService.get(this.cityUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
            return response.json();
        }));
    };
    ;
    ...
    Admin_DestinationService.prototype.updateCity = function (countryId, provienceId, city) {
        ...
        return this.dataService.putWithId(this.cityUrl, city).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
            return response.json();
        }));
    };
    Admin_DestinationService.prototype.createCity = function (countryId, provienceId, city) {
        this.cityUrl = "http://localhost:61125/api/countries/" + countryId + "/proviences/" + provienceId + "/cities/" + city.id;
        this.city = city;
        return this.dataService.post(this.cityUrl, city).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
            return response.json();
        }));
    };
    //----------------------------------------------------------------------------------------------------------
    Admin_DestinationService.prototype.getMonths = function () {
        ...
        return this.dataService.get(this.monthUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
            return response.json();
        }));
    };
    Admin_DestinationService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        __metadata("design:paramtypes", [_shared_service_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"], _shared_service_configuration_service__WEBPACK_IMPORTED_MODULE_3__["ConfigurationService"]])
