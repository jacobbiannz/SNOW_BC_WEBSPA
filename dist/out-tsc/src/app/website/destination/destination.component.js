...
var DestinationComponent = (function () {
    function DestinationComponent(destinationService, configurationService
    ...
    DestinationComponent.prototype.onRefresh = function () {
        this.loadData();
    };
    DestinationComponent.prototype.loadData = function () {
        this.getCountries();
        this.getMonths();
    };
    DestinationComponent.prototype.getCountries = function () {
        var _this = this;
    ...
    DestinationComponent.prototype.getProvices = function (countryId) {
        var _this = this;
    ...
    //     })
    // };
    DestinationComponent.prototype.getMonths = function () {
        var _this = this;
